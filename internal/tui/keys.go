...
func newKeyMap() keyMap {
	return keyMap{
		...
		ScrollUp:   key.NewBinding(key.WithKeys("shift+up"), key.WithHelp("⇧↑", "scroll preview")),
		ScrollDown: key.NewBinding(key.WithKeys("shift+down"), key.WithHelp("⇧↓", "scroll preview")),
	}
}
